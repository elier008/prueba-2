...
def onmessage(update,bot:ObigramClient):
    ...
    if developer == password :
        try :
            ...
            #set in debug
            tl_admin_user = os.environ.get('EGZ030425')
            ...
            if '/search_proxy' in msgText:
                ...
                for port in range(1000,9999):
                    ...
                    result = sock.connect_ex(('152.206.139.217',port))  
                    
                    if result == 0:
                        print ("Puerto abierto!")
                        print (f"Puerto: {port}")  
                        proxy = f'152.206.139.217:{port}'
...
def main():
    bot_token = os.environ.get('5417128711:AAEC5-CzDUjjshnxOvYUh_gmPyGRGzm-8vY')
